...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayout.setBackgroundColor(Color.rgb(51,99,255));
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://goo.gl/DN8UuD"));
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://goo.gl/f1QTmy"));
                startActivity(intent);
            }
        });
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://goo.gl/WUWXmy"));
                startActivity(intent);
            }
        });
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://goo.gl/ccd2w7"));
                startActivity(intent);
            }
        });
        ...
        new Thread() {
            public void run() {
                try {
                    com.ju.ho.detectwalkway.Element element[];
                    ...
                    element = new com.ju.ho.detectwalkway.Element[objectSize];

                    for (int n = 0; n < objectSize; n++) {

                        stringArr[n] = object.get(n).toString();
                        element[n] = new com.ju.ho.detectwalkway.Element();
